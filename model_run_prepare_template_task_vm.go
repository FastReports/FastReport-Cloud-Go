...
type _RunPrepareTemplateTaskVM RunPrepareTemplateTaskVM
...
func (o *RunPrepareTemplateTaskVM) UnmarshalJSON(data []byte) (err error) {
	...
	varRunPrepareTemplateTaskVM := _RunPrepareTemplateTaskVM{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRunPrepareTemplateTaskVM)

	if err != nil {
		return err
	}

	*o = RunPrepareTemplateTaskVM(varRunPrepareTemplateTaskVM)
