...
// checks if the UserProfileVM type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserProfileVM{}
...
type _UserProfileVM UserProfileVM
...
func (o *UserProfileVM) UnmarshalJSON(data []byte) (err error) {
	...
	varUserProfileVM := _UserProfileVM{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserProfileVM)

	if err != nil {
		return err
	}

	*o = UserProfileVM(varUserProfileVM)
