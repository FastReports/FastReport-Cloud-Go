...
type _RunInputFileVM RunInputFileVM
...
func (o RunInputFileVM) ToMap() (map[string]interface{}, error) {
	...
	serializedInputFileVM, errInputFileVM := json.Marshal(o.InputFileVM)
	if errInputFileVM != nil {
		return map[string]interface{}{}, errInputFileVM
	}
	errInputFileVM = json.Unmarshal([]byte(serializedInputFileVM), &toSerialize)
	if errInputFileVM != nil {
		return map[string]interface{}{}, errInputFileVM
	}
	if o.Content.IsSet() {
...
func (o *RunInputFileVM) UnmarshalJSON(data []byte) (err error) {
	...
	varRunInputFileVM := _RunInputFileVM{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRunInputFileVM)

	if err != nil {
		return err
	}

	*o = RunInputFileVM(varRunInputFileVM)
