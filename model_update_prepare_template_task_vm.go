...
type _UpdatePrepareTemplateTaskVM UpdatePrepareTemplateTaskVM
...
func (o *UpdatePrepareTemplateTaskVM) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdatePrepareTemplateTaskVM := _UpdatePrepareTemplateTaskVM{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdatePrepareTemplateTaskVM)

	if err != nil {
		return err
	}

	*o = UpdatePrepareTemplateTaskVM(varUpdatePrepareTemplateTaskVM)
