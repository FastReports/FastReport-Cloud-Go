...
func (r ApiConfigurationGetRequest) Execute() (ServerConfigurationVM, *_nethttp.Response, error) {
 ...
 */
func (a *ConfigurationApiService) ConfigurationGet(ctx _context.Context) ApiConfigurationGetRequest {
	return ApiConfigurationGetRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *ConfigurationApiService) ConfigurationGetExecute(r ApiConfigurationGetRequest) (ServerConfigurationVM, *_nethttp.Response, error) {
	var (
