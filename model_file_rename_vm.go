...
// checks if the FileRenameVM type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileRenameVM{}
...
type _FileRenameVM FileRenameVM
...
func (o *FileRenameVM) UnmarshalJSON(data []byte) (err error) {
	...
	varFileRenameVM := _FileRenameVM{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFileRenameVM)

	if err != nil {
		return err
	}

	*o = FileRenameVM(varFileRenameVM)
