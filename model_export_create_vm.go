...
type _ExportCreateVM ExportCreateVM
...
func (o *ExportCreateVM) UnmarshalJSON(data []byte) (err error) {
	...
	varExportCreateVM := _ExportCreateVM{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varExportCreateVM)

	if err != nil {
		return err
	}

	*o = ExportCreateVM(varExportCreateVM)
