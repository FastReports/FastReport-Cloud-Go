...
type _UpdateFetchTaskVM UpdateFetchTaskVM
...
func (o *UpdateFetchTaskVM) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateFetchTaskVM := _UpdateFetchTaskVM{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateFetchTaskVM)

	if err != nil {
		return err
	}

	*o = UpdateFetchTaskVM(varUpdateFetchTaskVM)
