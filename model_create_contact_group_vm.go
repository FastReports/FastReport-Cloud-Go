...
type _CreateContactGroupVM CreateContactGroupVM
...
func (o *CreateContactGroupVM) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateContactGroupVM := _CreateContactGroupVM{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateContactGroupVM)

	if err != nil {
		return err
	}

	*o = CreateContactGroupVM(varCreateContactGroupVM)
