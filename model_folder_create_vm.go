...
type _FolderCreateVM FolderCreateVM
...
func (o *FolderCreateVM) UnmarshalJSON(data []byte) (err error) {
	...
	varFolderCreateVM := _FolderCreateVM{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFolderCreateVM)

	if err != nil {
		return err
	}

	*o = FolderCreateVM(varFolderCreateVM)
