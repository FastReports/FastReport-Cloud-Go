...
type _CreateEmailTaskVM CreateEmailTaskVM
...
func (o *CreateEmailTaskVM) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateEmailTaskVM := _CreateEmailTaskVM{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateEmailTaskVM)

	if err != nil {
		return err
	}

	*o = CreateEmailTaskVM(varCreateEmailTaskVM)
