...
type _RenameDataSourceVM RenameDataSourceVM
...
func (o *RenameDataSourceVM) UnmarshalJSON(data []byte) (err error) {
	...
	varRenameDataSourceVM := _RenameDataSourceVM{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRenameDataSourceVM)

	if err != nil {
		return err
	}

	*o = RenameDataSourceVM(varRenameDataSourceVM)
