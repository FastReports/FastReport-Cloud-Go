...
type _SubscriptionUsersVM SubscriptionUsersVM
...
func (o *SubscriptionUsersVM) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionUsersVM := _SubscriptionUsersVM{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionUsersVM)

	if err != nil {
		return err
	}

	*o = SubscriptionUsersVM(varSubscriptionUsersVM)
