...
type _CreateTransformTaskBaseVM CreateTransformTaskBaseVM
...
func (o *CreateTransformTaskBaseVM) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateTransformTaskBaseVM := _CreateTransformTaskBaseVM{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateTransformTaskBaseVM)

	if err != nil {
		return err
	}

	*o = CreateTransformTaskBaseVM(varCreateTransformTaskBaseVM)
