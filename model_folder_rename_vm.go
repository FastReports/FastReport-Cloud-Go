...
type _FolderRenameVM FolderRenameVM
...
func (o *FolderRenameVM) UnmarshalJSON(data []byte) (err error) {
	...
	varFolderRenameVM := _FolderRenameVM{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFolderRenameVM)

	if err != nil {
		return err
	}

	*o = FolderRenameVM(varFolderRenameVM)
