...
func (o *ReportInfo) GetCreatorVersion() string {
	if o == nil || IsNil(o.CreatorVersion.Get()) {
		var ret string
		return ret
	}
...
func (o *ReportInfo) GetPreviewPictureRatio() float32 {
	if o == nil || IsNil(o.PreviewPictureRatio) {
		var ret float32
		return ret
	}
...
func (o *ReportInfo) GetSavePreviewPicture() bool {
	if o == nil || IsNil(o.SavePreviewPicture) {
		var ret bool
		return ret
	}
