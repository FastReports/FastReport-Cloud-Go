...
// checks if the RunTaskBaseVM type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RunTaskBaseVM{}
...
type _RunTaskBaseVM RunTaskBaseVM
...
func (o *RunTaskBaseVM) UnmarshalJSON(data []byte) (err error) {
	...
	varRunTaskBaseVM := _RunTaskBaseVM{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRunTaskBaseVM)

	if err != nil {
		return err
	}

	*o = RunTaskBaseVM(varRunTaskBaseVM)
