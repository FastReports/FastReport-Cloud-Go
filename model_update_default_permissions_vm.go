...
type _UpdateDefaultPermissionsVM UpdateDefaultPermissionsVM
...
func (o *UpdateDefaultPermissionsVM) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateDefaultPermissionsVM := _UpdateDefaultPermissionsVM{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateDefaultPermissionsVM)

	if err != nil {
		return err
	}

	*o = UpdateDefaultPermissionsVM(varUpdateDefaultPermissionsVM)
